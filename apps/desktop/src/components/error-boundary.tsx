...
export class ErrorBoundary extends Component<Props, State> {
    ...
    render() {
        ...
        return (
            <div className="bg-[url('/grid/grid-dark.svg')] bg-background">
                <header data-tauri-drag-region className="w-full h-11 absolute top-0 flex justify-end z-10 border-b">
                    <WindowControls />
                </header>
